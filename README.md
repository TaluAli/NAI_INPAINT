...
- 2026-07-05: API 전송용 마스크를 NovelAI식 1/8 저해상도 PNG로 보내고 V4 모델의 `native` noise schedule을 차단했습니다. / Changed API masks to NovelAI-style 1/8-resolution PNGs and blocked the `native` noise schedule for V4 models.
